...
namespace CitrioN.StyleProfileSystem
{
  public abstract class StyleListener : MonoBehaviour
  {
    ...
    protected abstract void ApplyChange(object value);
    ...
    protected virtual bool UpdateStyleFromProfile(StyleProfile styleProfile)
    {
  ...
  public abstract class GenericStyleListener<T> : StyleListener
  {
    ...
    protected override void ApplyChange(object value)
    {
